...
public class Kanner extends FrameLayout implements OnClickListener {
    private List<TopStoriesEntity> topStoriesEntities;
    ...
    public Kanner(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.topStoriesEntities = new ArrayList<TopStoriesEntity>();
        initView();
    }
    ...
    public void setTopEntities(List<TopStoriesEntity> topEntities) {
...
//            iv.setBackgroundResource(R.drawable.loading1);
    ...
    public void onClick(View v) {
        if (mItemClickListener != null) {
            TopStoriesEntity entity = topStoriesEntities.get(vp.getCurrentItem() - 1);
